    ...
    <div className="">
      <div className=" grid grid-cols-[1fr_0px] gap-y-8 px-20 lg:px-48 lg:grid-cols-2 main pt-40 pb-60  ">
        <div className="landing-animation-right">
          <h1 className="text-7xl font-bold mb-10 text-blue-600/75">
          ...
          <button className="font-kanit text-2xl text-royal bg-white border-4 border-royal px-10 py-5 mt-20 rounded-md shadow-md hover:scale-105 ease-in-out duration-200 landing-animation-right">
